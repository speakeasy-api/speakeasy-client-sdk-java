...
Gradle:
```groovy
implementation 'dev.speakeasyapi:javaclientsdk:7.20.16'
```
...
### [ChaseTest SDK](docs/sdks/chasetest/README.md)

* [generateCodeSamplePreview](docs/sdks/chasetest/README.md#generatecodesamplepreview) - Generate Code Sample previews from a file and configuration parameters.
* [generateCodeSamplePreviewAsync](docs/sdks/chasetest/README.md#generatecodesamplepreviewasync) - Initiate asynchronous Code Sample preview generation from a file and configuration parameters, receiving an async JobID response for polling.
* [getCodeSamplePreviewAsync](docs/sdks/chasetest/README.md#getcodesamplepreviewasync) - Poll for the result of an asynchronous Code Sample preview generation.
...
public class Application {
    ...
    public static void main(String[] args) throws Error, Exception {
        ...
        ChaseTest sdk = ChaseTest.builder()
                .server(ChaseTest.AvailableServers.PROD)
                .security(Security.builder()
                    .apiKey("<YOUR_API_KEY_HERE>")
                    .build())
            .build();
