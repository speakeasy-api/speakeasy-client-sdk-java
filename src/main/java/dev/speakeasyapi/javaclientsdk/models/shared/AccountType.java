 ...
 *
 */
@JsonDeserialize(using = AccountType._Deserializer.class)
@JsonSerialize(using = AccountType._Serializer.class)
public class AccountType {

    public static final AccountType FREE = new AccountType("free");
    public static final AccountType SCALE_UP = new AccountType("scale-up");
    public static final AccountType BUSINESS = new AccountType("business");
    public static final AccountType ENTERPRISE = new AccountType("enterprise");
    ...
    private static final Map<String, AccountTypeEnum> createEnumsMap() {
        ...
        map.put("free", AccountTypeEnum.FREE);
        map.put("scale-up", AccountTypeEnum.SCALE_UP);
        map.put("business", AccountTypeEnum.BUSINESS);
        map.put("enterprise", AccountTypeEnum.ENTERPRISE);
        return map;
    }
    
    @SuppressWarnings("serial")
    public static final class _Serializer extends StdSerializer<AccountType> {
        ...
        @Override
        public void serialize(AccountType value, JsonGenerator g, SerializerProvider provider)
    ...
    @SuppressWarnings("serial")
    public static final class _Deserializer extends StdDeserializer<AccountType> {
