...
public class GetGithubSetupStateRequest {
    ...
    @JsonCreator
    public GetGithubSetupStateRequest(
    ...
    public GetGithubSetupStateRequest withGenerateGenLockId(String generateGenLockId) {
        Utils.checkNotNull(generateGenLockId, "generateGenLockId");
        this.generateGenLockId = generateGenLockId;
        return this;
    }

    public GetGithubSetupStateRequest withOrg(String org) {
        Utils.checkNotNull(org, "org");
        this.org = org;
        return this;
    }

    public GetGithubSetupStateRequest withRepo(String repo) {
        Utils.checkNotNull(repo, "repo");
        this.repo = repo;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetGithubSetupStateRequest other = (GetGithubSetupStateRequest) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetGithubSetupStateRequest.class,
    ...
    public final static class Builder {
        ...
        public GetGithubSetupStateRequest build() {
            return new GetGithubSetupStateRequest(
                generateGenLockId,
                org,
                repo);
        }
