...
public class GithubCheckPublishingPRsRequest {
    ...
    @JsonCreator
    public GithubCheckPublishingPRsRequest(
    ...
    public GithubCheckPublishingPRsRequest withGenerateGenLockId(String generateGenLockId) {
        Utils.checkNotNull(generateGenLockId, "generateGenLockId");
        this.generateGenLockId = generateGenLockId;
        return this;
    }

    public GithubCheckPublishingPRsRequest withOrg(String org) {
        Utils.checkNotNull(org, "org");
        this.org = org;
        return this;
    }

    public GithubCheckPublishingPRsRequest withRepo(String repo) {
        Utils.checkNotNull(repo, "repo");
        this.repo = repo;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GithubCheckPublishingPRsRequest other = (GithubCheckPublishingPRsRequest) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GithubCheckPublishingPRsRequest.class,
    ...
    public final static class Builder {
        ...
        public GithubCheckPublishingPRsRequest build() {
            return new GithubCheckPublishingPRsRequest(
                generateGenLockId,
                org,
                repo);
        }
