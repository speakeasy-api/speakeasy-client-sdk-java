...
class SDKConfiguration {
    ...
    public HTTPClient defaultClient;
  	...
  	public String sdkVersion = "7.12.2";
  	public String genVersion = "2.299.1";
  	public String userAgent = "speakeasy-sdk/java 7.12.2 2.299.1 0.4.0 io.github.speakeasy_sdks_staging.javaclientsdk";
